...
test('of', () => {
    ...
    expect(RD.of({ loading: true, value: "testing", failure: "no" })).toEqual(RD.loading)
    expect(RD.of({ loading: true, value: undefined, failure: "no" })).toEqual(RD.loading)

    expect(RD.of({ failure: "oh no", loading: false })).toEqual(RD.failure("oh no"))
    expect(RD.of({ loading: false, failure: "oh no" })).toEqual(RD.failure("oh no"))
    expect(RD.of({ failure: "oh no", value: "oh no", loading: false })).toEqual(RD.failure("oh no"))
    expect(RD.of({ loading: false, value: "testing", failure: "oh no" })).toEqual(RD.failure("oh no"))
    expect(RD.of({ loading: false, value: undefined, failure: "oh no" })).toEqual(RD.failure("oh no"))
